...
shinyServer(function(input, output) {
  ...
  inputTemplate <- "/home/shiny-ot2/ShinyApps/ot2/Plate384/Template384_PlateMap.xlsx"
  sourceDir <- "/home/shiny-ot2/ShinyApps/ot2/Plate384/lauraPlate_processor.R"
