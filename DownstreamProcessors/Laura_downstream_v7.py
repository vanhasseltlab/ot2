...
#mainwd = 'C:\\Users\\sebas\\OneDrive\\Documents\\WebServer\\Incubator\\CustomMV_plate'
#mainInput = "testOutput_newDefined.csv"
mainInput = "CommandList2.csv"
...
def translate_labwareLibrary(string_identifier):
    ...
    elif("falcon" in string_identifier):
    ...
    for i in range(len(aspirate_groups2)):
        ...
        if(operation==1):
            ...
            while(transferV>0):
                ...
                c_pipette.flow_rate.dispense=current_aspSpeed
            ...
            for j in range(len(c_target_deck)):
                ...
                c_pipette.flow_rate.dispense=cal_transferSpeed(float(c_amt[j]))
