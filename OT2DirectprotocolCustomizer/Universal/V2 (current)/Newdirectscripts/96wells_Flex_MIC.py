...
def ReadCSV_Dat(file_name):
    ...
    for i in range(len(deck_loc)):
        ...
        elif('tip' in fill[i] or 'Tip' in fill[i]) and (filteredtip == 'none' or filteredtip == 'p50'):
            fill[i] = "opentrons_flex_96_tiprack_1000ul"
        elif('tip' in fill[i] or 'Tip' in fill[i]) and (filteredtip == 'both' or filteredtip == 'p1000'):
            fill[i] = "opentrons_flex_96_filtertiprack_1000ul"
